...
namespace Photon.Pun.UtilityScripts
{
    ...
    public static class PlayerNumberingExtensions
    {
		...
		/// Make sure you use the delegate 'OnPlayerNumberingChanged' to know when you can query the PlayerNumber. Numbering can changes over time or not be yet assigned during the initial phase ( when player creates a room for example)
		/// </summary>
